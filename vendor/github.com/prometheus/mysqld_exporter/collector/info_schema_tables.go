...
var (
	infoSchemaTablesVersionDesc = prometheus.NewDesc(
		...
		[]string{"schema", "table", "type", "engine", "row_format", "create_options", "_workgroup_name", "workgroup_name", "addr", "cluster", "instanceId", "workgroup_id"}, nil,
	)
	infoSchemaTablesRowsDesc = prometheus.NewDesc(
		...
		[]string{"schema", "table", "_workgroup_name", "workgroup_name", "addr", "cluster", "instanceId", "workgroup_id"}, nil,
	)
	infoSchemaTablesSizeDesc = prometheus.NewDesc(
		...
		[]string{"schema", "table", "component", "_workgroup_name", "workgroup_name", "addr", "cluster", "instanceId", "workgroup_id"}, nil,
	)
)
...
func (ScrapeTableSchema) Scrape(ctx context.Context, db *sql.DB, ch chan<- prometheus.Metric, logger log.Logger, Instance master.Instance) error {
