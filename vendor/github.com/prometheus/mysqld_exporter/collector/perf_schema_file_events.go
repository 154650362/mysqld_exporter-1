...
var (
	performanceSchemaFileEventsDesc = prometheus.NewDesc(
		...
		[]string{"event_name", "mode", "_workgroup_name", "workgroup_name", "addr", "cluster", "instanceId", "workgroup_id"}, nil,
	)
...
func (ScrapePerfFileEvents) Scrape(ctx context.Context, db *sql.DB, ch chan<- prometheus.Metric, logger log.Logger, Instance master.Instance) error {
	...
	for perfSchemaFileEventsRows.Next() {
		...
		ch <- prometheus.MustNewConstMetric(
			...
			eventName, "read", Instance.WorkGroupName, Instance.WorkGroupName, Instance.Addr, Instance.WorkGroupName, Instance.Addr, Instance.WorkGroupID,
		)
		ch <- prometheus.MustNewConstMetric(
		...
		ch <- prometheus.MustNewConstMetric(
			...
			eventName, "write", Instance.WorkGroupName, Instance.WorkGroupName, Instance.Addr, Instance.WorkGroupName, Instance.Addr, Instance.WorkGroupID,
		)
		ch <- prometheus.MustNewConstMetric(
		...
		ch <- prometheus.MustNewConstMetric(
			...
			eventName, "misc", Instance.WorkGroupName, Instance.WorkGroupName, Instance.Addr, Instance.WorkGroupName, Instance.Addr, Instance.WorkGroupID,
		)
		ch <- prometheus.MustNewConstMetric(
